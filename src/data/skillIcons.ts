...
export const SKILL_ICONS: Record<string, SkillIcon> = {
  ...
  JavaScript:          { src: "devicon:javascript" },
  Python:              { src: "devicon:python" },
  Java:                { src: "devicon:java" },
  "C#":                { src: "devicon:csharp" },
  "C++":               { src: "devicon:cplusplus" },
  React:               { src: "devicon:react" },
  "React 19":          { src: "devicon:react" },
  "React 18/19":       { src: "devicon:react" },
  "Chakra UI":         { src: "simpleicons:chakraui" },
  "Module Federation": { src: "devicon:webpack" },
  Rspack:              { src: "simpleicons:rspack" },
  "Entity Framework Core": { src: "simpleicons:dotnet" },
  Karma:               { src: "devicon:karma" },
  Chai:                { src: "simpleicons:chai" },
  Sinon:               { src: "simpleicons:sinon" },
  Selenium:            { src: "devicon:selenium" },
  Firebase:            { src: "devicon:firebase" },
  Redis:               { src: "devicon:redis" },
  "AWS CodeArtifact":  { src: "devicon:amazonwebservices/original-wordmark" },
  Azure:               { src: "devicon:azure" },
